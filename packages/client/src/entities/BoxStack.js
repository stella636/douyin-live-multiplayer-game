...
const LOOT_TYPES = ["sword", "shield", "scroll", "potion", "coin", "gem"];
export class BoxStack {
    constructor(scene) {
        this.isPlayingHit = false;
        this.baseColor = 0xc4a574;
        this.stage = "wood";
...
function getStageStyle(stage, tint) {
    switch (stage) {
        case "royal":
            return {
